...
public class OldPanelDialog extends JLabel {
    ...
    public Thread main,nextDialog;
     ...
     public OldPanelDialog(JFrame frame, JPanel panel, ImageIcon icon, int y, String[] texts, Thread nextDialog , Font font) {
