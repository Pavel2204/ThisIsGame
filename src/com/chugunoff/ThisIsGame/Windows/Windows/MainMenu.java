package com.chugunoff.ThisIsGame.Windows.Windows;

import com.chugunoff.ThisIsGame.Engine.Graphics.CutScene.Slide;
import com.chugunoff.ThisIsGame.Engine.Graphics.Dialog.GraphicsDictor;
import com.chugunoff.ThisIsGame.Engine.Utils.IconInfo;
import com.chugunoff.ThisIsGame.Engine.Utils.Sleep;
import com.chugunoff.ThisIsGame.InfoClasses.Config;
import com.chugunoff.ThisIsGame.Engine.IOGame.Load;
import org.python.bouncycastle.jcajce.provider.symmetric.AES;
    ...
    void initObjects() {
        ...
        Settings.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                new GraphicsDictor().speak("Никита хочет кушац.",GameName,10L);
                NewGame.setIcon(Config.resources.NewGameDeact);
                com.chugunoff.ThisIsGame.Windows.Windows.Settings ST = new Settings();
